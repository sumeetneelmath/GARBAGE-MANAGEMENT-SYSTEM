...
(1, 'Yashwanth Kumar A S', 'yashu', 8217493108, 'manjuyashumanjuyashu137@gmail', 'f925916e2754e5e03f75dd58a5733251', '2024-11-14 12:23:36');
...
(1, 'aboutus', 'About Us', '<span style=\"color: rgb(32, 33, 36); font-family: arial, sans-serif; font-size: 16px;\"><b>\"GARBAGE COLLECTION SYSTEM\"</b>&nbsp;</span><div><font color=\"#202124\" face=\"arial, sans-serif\"><span style=\"font-size: 16px;\">It helps garbage collector to maintain and view lodged complain against garbage.</span></font></div>', NULL, NULL, NULL),
(2, 'contactus', 'Contact Us', 'GOVT. ENGINEERING COLLEGE MOSALEHOSALLI', 'manjuyashumanjuyashu137@gmail.com', 8217493108, NULL);
